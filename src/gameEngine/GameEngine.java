...
public class GameEngine {
	...
	private void displayInstructions() {
		...
		System.out.println("Plastic straws multiply and will deal damage if you get too close");
		System.out.println("Wrong Names will kill if you spend to much time near them");
		System.out.println("get the Pumpkin spice lattes (X) to win and advance");
